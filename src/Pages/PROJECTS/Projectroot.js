...
import redbus from "./Projectimages/redbus.png";
import cardeko from "./Projectimages/car_pr2.png";
import flipk from "./Projectimages/flip_pr.png";
import MS from "./Projectimages/microsoft_pr.png";
      ...
      <Timeline position="alternate">
          ...
          >
           <Card className="cardstyleproject2">
              <CardHeader
                ...
                subheader="Predicting Used Car Prices with Data-Driven Insights.pyn"
              />
              ...
              <CardActions disableSpacing>
                ...
                <IconButton>
                  <a
                    href="https://github.com/Chitradevid/CARDEKHO"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <Button color="secondary" variant="contained">
          ...
          <TimelineContent>
            ...
            >
              <CardHeader
                ...
                //   </Avatar>
                // }
                title="Redbus Data Scraping and Filtering with Streamlit"
                subheader="Automating Bus Travel Data Collection and Analysis for Smarter Transportation Decisions"
              />

              <CardMedia component="img" image={redbus} alt="Booking App" />
              ...
              <CardActions disableSpacing>
                ...
                <IconButton>
                  <a
                    href="https://github.com/Chitradevid/RedbusDetails"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <Button color="secondary" variant="contained">
        ...
        <TimelineItem>
          ...
          >
           <Card className="cardstyleproject2">
              <CardHeader
                title="Product Recommendations with Live Sentiment Analysis"
                subheader="Web Scraping Flipkart Reviews Using LangChain and Deploying on AWS"
              />
              ...
              <CardActions disableSpacing>
                ...
                <IconButton>
                  <a
                    href="https://github.com/Chitradevid/FLIPKART"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <Button color="secondary" variant="contained">
          ...
          <TimelineContent>
            ...
            >
              <CardHeader
                ...
                title="Classifying Cybersecurity Incidents with Machine Learning"
                subheader="Predicting Triage Grades with AI-Powered Threat Detection"
              />

              <CardMedia component="img" image={MS} alt="Todo App" />
              ...
              <CardActions disableSpacing>
                ...
                <IconButton>
                  <a
                    href="https://github.com/Chitradevid/MICROSOFT"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <Button color="secondary" variant="contained">
